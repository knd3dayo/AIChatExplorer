namespace LibUINormalChat.Resources {
    public class NormalChatStringResources  {

        private static NormalChatStringResources? _instance;
        public static NormalChatStringResources Instance {
            get {
                if (_instance == null || _LangChanged) {
                    _LangChanged = false;
                    switch (Lang) {
                        case "ja-JP":
                            _instance = new NormalChatStringResourcesJa();
                            break;
                        default:
                            _instance = new NormalChatStringResources();
                            break;
                    }
                }
                return _instance;
