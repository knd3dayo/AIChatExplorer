...
class LangChainVectorDB:
    ...
    def get_vector_db(openai_props: OpenAIProps, vector_db_props: VectorDBItem):
        ...
        if vector_db_props.VectorDBTypeString == "Chroma":
            from clipboard_app.langchain_modules.langchain_vector_db_chroma import LangChainVectorDBChroma
        ...
        # ベクトルDBのタイプがPostgresの場合
            ...
            from clipboard_app.langchain_modules.langchain_vector_db_pgvector import LangChainVectorDBPGVector
