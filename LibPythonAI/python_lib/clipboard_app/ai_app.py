...
from clipboard_app.openai_modules import OpenAIProps, OpenAIClient, RequestContext
from clipboard_app.langchain_modules import LangChainChatParameter, LangChainUtil, LangChainVectorDB, VectorSearchParameter
from clipboard_app.file_modules import ExcelUtil, FileUtil
...
def run_openai_chat(openai_props: OpenAIProps, vector_db_items: list[VectorDBItem], request_context: RequestContext, request: dict) -> dict[str, str]:
    ...
    def vector_search(query: str) -> dict:
        from clipboard_app.db_modules import VectorSearchParameter
