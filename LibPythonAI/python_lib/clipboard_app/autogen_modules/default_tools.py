...
def extract_file(file_path: Annotated[str, "File path"]) -> str:
    ...
    """
    from clipboard_app.file_modules.file_util import FileUtil
...
def list_tools() -> Annotated[list[dict[str, str]], "List of registered tools, each containing 'name' and 'description'"]:
    ...
    global autogen_props
    from clipboard_app.db_modules import MainDB
    from clipboard_app.autogen_modules import AutoGenProps
    props : AutoGenProps = autogen_props # type: ignore
...
def register_tool(
    ...
    global autogen_props
    from clipboard_app.db_modules import MainDB, AutogenTools
    from clipboard_app.autogen_modules import AutoGenProps
    props : AutoGenProps = autogen_props # type: ignore
    autogen_db_path = props.autogen_db_path
...
def register_tool_agent(
    ...
    global autogen_props
    import os
    from clipboard_app.db_modules import MainDB, AutogenTools, AutogenAgent
    from clipboard_app.autogen_modules import AutoGenProps
    props : AutoGenProps = autogen_props # type: ignore
    autogen_db_path = props.autogen_db_path
    # sqlite3のDBを開く
