...
namespace LibUIMain.ViewModel.PromptTemplate {
    public class ListPromptTemplateWindowViewModel : CommonViewModelBase {
        ...
        public Visibility ExecButtonVisibility {
            get {
                ...
                return LibUIMain.Utils.Tools.BoolToVisibility(ActionMode == ActionModeEum.Exec || ActionMode == ActionModeEum.Select);
            }
        }
        // Modeの表示
        public Visibility ModeVisibility {
            get {
                ...
                return LibUIMain.Utils.Tools.BoolToVisibility(ActionMode == ActionModeEum.Exec);
            }
        }
