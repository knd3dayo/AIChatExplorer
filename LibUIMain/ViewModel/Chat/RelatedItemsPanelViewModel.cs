...
namespace LibUIMain.ViewModel.Chat {
    public class RelatedItemsPanelViewModel : CommonViewModelBase {
        ...
        public RelatedItemsPanelViewModel(ContentFolderViewModel folderViewModel, ObservableCollection<ContentItemViewModel> selectedItems, Action<bool> updateIndeterminate) {
        ...
        public RelatedItemsDataGridViewControlViewModel MergeTargetDataGridViewControlViewModel { get; set; }

        public RelatedItemsTreeViewControlViewModel MergeTargetTreeViewControlViewModel { get; set; }
        ...
        public Visibility PropertiesVisibility {
            get {
                return Utils.Tools.BoolToVisibility(ShowProperties);
            }
        }
    }

    public class RelatedItemsDataGridViewControlViewModel : CommonViewModelBase {

        public RelatedItemsDataGridViewControlViewModel(Action<bool> updateIndeterminateAction) {
