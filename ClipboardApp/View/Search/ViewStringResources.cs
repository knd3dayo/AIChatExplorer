...
namespace ClipboardApp.View.Search {
    public class ViewStringResources {
        ...
        // SearchTargetFolder
        public static string SearchTargetFolder { get; set; } = CommonStringResources.SearchTargetFolder;

        // Select
        public static string SelectFolder { get; set; } = CommonStringResources.SelectFolder;

        // Exclude
        public static string Exclude { get; set; } = CommonStringResources.Exclude;

        // Content
        public static string Content { get; set; } = CommonStringResources.Content;

        // Tag
        public static string Tag { get; set; } = CommonStringResources.Tag;

        // CopySourceAppName
        public static string CopySourceAppName { get; set; } = CommonStringResources.CopySourceAppName;
        ...
        // StartDate
        public static string StartDate { get; set; } = CommonStringResources.StartDate;

        // IncludeSubfolders
        public static string IncludeSubfolders { get; set; } = CommonStringResources.IncludeSubfolders;

        // Clear
        public static string Clear { get; set; } = CommonStringResources.Clear;

        // EndDate
        public static string EndDate { get; set; } = CommonStringResources.EndDate;
